# This file is vendored/modified from matplotlib, making it an optional
...
for (name, data) in (('magma', _magma_data),
    ...
    cmaps[name] = np.array(data, dtype=np.float32)
    # generate reversed colormap
    name = name + '_r'
    cmaps[name] = np.array(list(reversed(data)), dtype=np.float32)
